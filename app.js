const translations = {
    uz: {
        page_title: "SalesNews.uz - Sales Master, Telegram Premium, Stars, TON NFT va garant xizmatlar",
        meta_desc: "SalesNews.uz - Sales Master guruhi, @xolid, @sales_master, @rijol, @yevropa, @uchar, @rejissor, @oshiq, @hattob, @shaxs, @kelishgan, Telegram Premium, Stars, TON NFT, GetGems emoji, garant forum va rasmiy Sales ekotizimi.",
        loading: "Yuklanmoqda...",
        ...
        hero_desc: "Sales Master guruhi, Premium, Stars, garant forum va TON NFT havolalari bir joyda.",
        ...
        team_desc: "Rasmiy adminlar va mas'ul shaxslar.",
        mnav_home: "Bosh",
        mnav_eco: "Eko",
        mnav_market: "Bozor",
        mnav_team: "Jamoa",
    ...
    en: {
        page_title: "SalesNews.uz - Sales Master, Telegram Premium, Stars, TON NFT and guarantor services",
        meta_desc: "SalesNews.uz - Sales Master group, @xolid, @sales_master, @rijol, @yevropa, @uchar, @rejissor, @oshiq, @hattob, @shaxs, @kelishgan, Telegram Premium, Stars, TON NFT, GetGems emoji, guarantor forum and official Sales ecosystem.",
        loading: "Loading...",
        nav_home: "Home",
        ...
        hero_desc: "Sales Master group, Premium, Stars, guarantor forum and TON NFT links in one place.",
